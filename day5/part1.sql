    ...
    states
        as (select 0                                    as state_number,
            ...
            select state_number + 1,
                   ...
                   case
                       when moves.from_stack = 1 then stack_1[2:cardinality(stack_1)]
                       when moves.to_stack = 1 then array_remove(array_prepend(
                                                                         case
                   ...
                   case
                       when moves.from_stack = 2 then stack_2[2:cardinality(stack_2)]
                       when moves.to_stack = 2 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
                   ...
                   case
                       when moves.from_stack = 3 then stack_3[2:cardinality(stack_3)]
                       when moves.to_stack = 3 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
                   ...
                   case
                       when moves.from_stack = 4 then stack_4[2:cardinality(stack_4)]
                       when moves.to_stack = 4 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
                   ...
                   case
                       when moves.from_stack = 5 then stack_5[2:cardinality(stack_5)]
                       when moves.to_stack = 5 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
                   ...
                   case
                       when moves.from_stack = 6 then stack_6[2:cardinality(stack_6)]
                       when moves.to_stack = 6 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
                   ...
                   case
                       when moves.from_stack = 7 then stack_7[2:cardinality(stack_7)]
                       when moves.to_stack = 7 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
                   ...
                   case
                       when moves.from_stack = 8 then stack_8[2:cardinality(stack_8)]
                       when moves.to_stack = 8 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
                   ...
                   case
                       when moves.from_stack = 9 then stack_9[2:cardinality(stack_9)]
                       when moves.to_stack = 9 then array_remove(array_prepend(
                                                                         case
                                                                             when moves.from_stack = 1
                                                                                 then stack_1[1]
                                                                             when moves.from_stack = 2
...
select
       concat(states.stack_1[1], states.stack_2[1], states.stack_3[1], states.stack_4[1], states.stack_5[1],
               states.stack_6[1], states.stack_7[1], states.stack_8[1], states.stack_9[1])
from states
order by states.state_number desc
limit 1;
--select distinct on (col) val
--from filtered_blanks
